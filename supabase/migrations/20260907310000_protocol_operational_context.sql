-- Inclui regras operacionais do condomínio no contexto de prescrição.
...
BEGIN
  ...
  SELECT jsonb_build_object(
    'capacidade', o.capacidade_academia,
    'horarios', o.horarios_academia,
    'restricoes', to_jsonb(o.restricoes_academia)
  ) INTO v_rules FROM public.organizations o WHERE o.id = v_org;
  RETURN jsonb_build_object(
    'aluno_id', p_aluno_id,
    'organization_id', v_org,
    'seguranca', COALESCE(v_safety, '{}'::jsonb),
    'infraestrutura', v_equipment,
    'regras_operacionais', COALESCE(v_rules, '{}'::jsonb),
